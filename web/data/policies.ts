...
export const technicalTables: TechnicalTable[] = [
  {
    ...
    keywords: ['tlv', 'tlv-twa', 'tlv-stel', 'threshold limit', 'threshold limits', 'threshold value', 'threshold values', 'limit value', 'limit values', 'chemical exposure limit', 'permissible exposure', 'pel', 'occupational exposure', 'oel', 'airborne concentration', 'exposure limit'],
